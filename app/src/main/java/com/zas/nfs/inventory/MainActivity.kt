...
fun CarListScreen(modifier: Modifier = Modifier) {
    val data = CarListService().getCarsList(Scope.ALL)
    LazyColumn(modifier = modifier.padding(4.dp)) {
        items(items = data) { carDetails ->
...
@Composable
fun CardContent(data: CarDetails) {
    ...
    Row(
        ...
        Column(
            ...
            Text(text = "Hello, ")
            Text(
                text = data.getName(), style = MaterialTheme.typography.headlineMedium.copy(
